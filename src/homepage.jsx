        ...
        <div className="">
          <div className="grid grid-cols-1">
            ...
            <div className="grid grid-rows-1" >
              <button onClick={toSpecificApartment} className="flex w-60 ml-44 ml-20, mb-28 select-none rounded-lg bg-gradient-to-tr from-logo to-logo py-3 px-9 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" >
                <svg
