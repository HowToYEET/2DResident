...
class Apartment {
    constructor(ZipCode, city ,RoadName, sqm, images, price, year, roomNumber, floornumber, sqmPrice, EnergyLevel) {
...
const ListOfApartments = [
    ...
    ,
    4298000, 1916, 7, 2, 22984, Energy.D
    ),
    ...
    1245000, 2018, 2, 2, 27667, Energy.A15
    ),
