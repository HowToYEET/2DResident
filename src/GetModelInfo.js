...
const ModelInfo_2 = new ModelInfo(
  ...
  [
    ...
    {
      title: "Bathroom",
      position: { x: 1.3, y: 1.5, z: -0.8 },
      lookAt: { x: 1.7, y: 1.4, z: -1.19 },
    },
  ],
  {
    z1: 2,
...
const ModelInfo_3 = new ModelInfo(
  ...
  [
    ...
    },
    {
      ...
      position: { x: 12.1, y: 1.6, z: 8.14 },
      lookAt: { x: 15.01, y: 1.2, z: 5.9 },
    },
    {
      title: "Bathroom",
      position: { x: 10.8, y: 1.6, z: 8.2 },
      lookAt: { x: 10.8, y: 1.2, z: 6.2 },
    },
  ],
  {
    z1: 12.8,
...
const ModelInfo_5 = new ModelInfo(
  ...
  [
    ...
    },
    {
      ...
      position: { x: -10.5, y: 1.65, z: -2.6 },
      lookAt: { x: -12.1, y: 1.3, z: -1.5 },
    },
  ],
  {
    z1: 4,
  ...
  [
    ...
    {
      Args: [0.62, 0.83],
      Position: [-12.995, 1.5, -0.677],
      Rotation: [0, Math.PI * 0.5, 0],
    },
    {
      Args: [0.62, 0.83],
      Position: [-12.995, 1.5, -1.637],
      Rotation: [0, Math.PI * 0.5, 0],
    },
  ],
  60,
...
const ModelInfo_8 = new ModelInfo(
  ...
  [
    {
      title: "Kitchen",
      position: { x: 4.8, y: 1.55, z: 3.1 },
      lookAt: { x: 2.9, y: 1.4, z: 3.7 },
    },
    {
      title: "Livingroom",
      position: { x: 4.6, y: 1.55, z: 2.7 },
      lookAt: { x: 7.2, y: 1.3, z: 4.2 },
    },
    {
      title: "Bedrooms",
      position: { x: 4.3, y: 1.55, z: 5.5 },
      lookAt: { x: 3.2, y: 1.4, z: 7.8 },
    },
    {
      title: "Bathroom",
      position: { x: 5.3, y: 1.55, z: 6.9 },
